    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income_name', models.CharField(max_length=50, null=True, verbose_name='收件人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(choices=[(True, '已使用'), (False, '未使用')], default=False, verbose_name='邮件状态')),
            ],
            options={
